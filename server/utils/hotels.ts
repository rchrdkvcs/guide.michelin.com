...
export const hotels: Hotel[] = [
  {
    ...
    longDescription: 'Perché sur les falaises de granit de Dinard, le Castelbrac est un hôtel 5 étoiles qui allie le charme d\'une demeure du XIXe siècle aux exigences du luxe contemporain. Avec sa vue imprenable sur la mer et ses jardins en terrasses, cet établissement offre une expérience unique en Bretagne.',
  ...
  },
  {
    ...
    description: 'Le luxe impérial face à l\'Atlantique, là où Napoléon III bâtit sa villa pour Eugénie.',
    ...
    amenities: ['Spa thalasso', 'Piscine intérieure', 'Restaurant étoilé', 'Bar', 'Plage privée', 'Salle de bal'],
  },
  {
    id: 'h3',
    slug: 'villa-koegelhoff',
    name: 'Villa Koegelhoff',
    description: 'Maison d\'hôtes alsacienne nichée entre vignes et forêts, à deux pas de Strasbourg.',
    longDescription: 'La Villa Koegelhoff est un refuge intimiste au cœur du vignoble alsacien. Dans une demeure bourgeoise du début du XXe siècle entièrement restaurée, elle propose des chambres d\'exception décorées avec soin, une table gastronomique qui célèbre les produits du terroir et un jardin paisible face aux vignes.',
  ...
  },
  {
    ...
    description: 'Le premier hôtel vinothérapie du monde, au cœur du vignoble bordelais de Smith Haut Lafitte.',
    ...
    amenities: ['Spa vinothérapie', 'Piscine', 'Restaurant étoilé', 'Bar à vins', 'Vélos', 'Visites vignoble'],
  },
  {
    id: 'h5',
    slug: 'le-mas-de-peint',
    name: 'Le Mas de Peint',
    description: 'Un mas camarguais authentique entre rizières et étangs, au cœur de la Camargue sauvage.',
  ...
  },
  {
    ...
    amenities: ['Spa Sisley', 'Piscine panoramique', 'Restaurant gastronomique', 'Bar', 'Salle de conférences'],
  },
]
