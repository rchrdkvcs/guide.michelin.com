...
const regions = [
  ...
  },
  {
    ...
    d: "M 150 220 L 200 200 L 200 300 L 150 300 Z",
  },
  {
    id: "nouvelle-aquitaine",
    name: "Nouvelle-Aquitaine",
    d: "M 100 300 L 250 300 L 250 500 L 100 500 Z",
  },
  { id: "occitanie", name: "Occitanie", d: "M 250 400 L 400 400 L 400 550 L 250 550 Z" },
  {
    id: "auvergne-rhone-alpes",
    name: "Auvergne-Rhône-Alpes",
    d: "M 300 300 L 450 300 L 450 450 L 300 450 Z",
  },
  {
    id: "provence-alpes-cote-d-azur",
    name: "Provence-Alpes-Côte d'Azur",
    d: "M 400 450 L 500 450 L 500 550 L 400 550 Z",
  },
  {
        ...
        <path
          ...
          :class="[
            ...
            mappedId === region.id
              ...
              : 'fill-linen-200 hover:fill-linen-300',
          ]"
          :fill="
            mappedId === region.id
              ? region.id === 'bretagne'
                ? 'url(#flag-bretagne)'
                : region.id === 'nouvelle-aquitaine' && activeRegionId === 'pays-basque'
                  ? 'url(#flag-pays-basque)'
                  : 'var(--color-brand-500)'
              : ''
          "
        >
