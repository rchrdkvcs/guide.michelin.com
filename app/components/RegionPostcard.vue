...
<template>
  <div class="perspective-1000 h-full aspect-3/2 cursor-pointer group shrink-0" @click="toggleFlip">
    <div
    ...
    >
      ...
      <div class="absolute inset-0 backface-hidden">
        <div class="w-full h-full bg-muted p-4 shadow-md border-2 border-default">
          <div class="w-full h-full relative overflow-hidden">
            ...
            >
              <h3 class="text-muted text-xl uppercase tracking-widest">
                {{ adventure.name }}
              </h3>
              <p class="text-muted text-sm font-mono">FRANCE</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="absolute inset-0 backface-hidden rotate-y-180">
        <div
          class="w-full h-full bg-muted p-4 shadow-md border-2 border-default grid grid-cols-[1fr_1px_0.75fr] gap-4"
        >
          <!-- Left: Title / Message -->
