...
<template>
  <main style="width: 100%; overflow-x: hidden;">
    <section id="region-hero" style="height: 800px; width: 100%; display: flex; justify-content: center; align-items: center; overflow: hidden;">
      <img :src="regionImage.src" :alt="regionImage.alt" style="width: 100%; height: 100%; object-fit: cover;">
    </section>

    <section id="intro-text" style="height: 800px; width: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 40px; box-sizing: border-box; text-align: center;">
    ...
    <section id="secondary-text" style="height: 800px; width: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 40px; box-sizing: border-box; text-align: center;">
